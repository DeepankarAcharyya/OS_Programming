...
int main(){
    ...
    if (pid<0){
        ...
        // int count1;
        // printf("\n12a\n");
        // read(shared_count_child[0],&count1,sizeof(count1));
        // printf("\n12a\n");
        // count1++;
        // printf("\n12a\n");
        // write(shared_count_child[1],&count1,sizeof(count1));
        // printf("\n12a\n");
        ...
        if (pid_grand<0){
            ...
            // int count2;
            // printf("\n13a\n");
            // read(shared_count_grand[0],&count2,sizeof(count2));
            // printf("\n13a\n");
            // count2++;
            // printf("\n13a\n");
            // write(shared_count_grand[1],&count2,sizeof(count2));
            // printf("\n13a\n");
            int add=(int)getpid();
